...
public class BookingmanagementImpl extends AbstractComponentFacade implements Bookingmanagement {
  ...
  public BookingEto findBookingByDeviceId(TableEto table) {
    ...
    eto.setId(booking.getId());
    eto.setBookingToken(booking.getBookingToken());
    return eto;
  }
  ...
  private void sendConfirmationEmailToHost(BookingEntity booking) {
    ...
    try {
      ...
      hostMailContent.append("Hi ").append(booking.getName()).append(" your booking has been confirmed.").append("\n");
